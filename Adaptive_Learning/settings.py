...
SECRET_KEY = 'django-insecure-v3@h2y!-=-(tn0e*m9h1xki#&q*rk(ju_#sv7qwk-u7jg#hig5'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'harishragavendrajayaraj@gmail.com'  # Use your email
EMAIL_HOST_PASSWORD = 'ysxi wcsy cfzu lbvl'  # Use your app password
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # Old app
    'Student',  # New app
    'rest_framework',
    'django_extensions',
    'user_visit',
...
MIDDLEWARE = [
    ...
    'user_visit.middleware.UserVisitMiddleware',  # New middleware
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '5/hour',  # 5 requests per hour for unauthenticated users
