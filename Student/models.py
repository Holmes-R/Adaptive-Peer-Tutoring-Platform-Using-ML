...
class LoginForm(models.Model):
    ...
    user_password = models.CharField(null=False, max_length=128)  # Increased length for hashed passwords
    confirm_password = models.CharField(null=False, max_length=128)  # Increased length for hashed passwords
    ...
    def is_otp_valid(self, otp):
        if self.generated_otp == otp and self.otp_expiry and self.otp_expiry > timezone.now():
            return True
        return False
